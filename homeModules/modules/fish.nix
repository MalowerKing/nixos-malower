  ...
  programs.fish = {
    ...
    interactiveShellInit = ''
      ...
      starship init fish | source
             ...
             alias update="sudo nix flake update --flake ./ && sudo nixos-rebuild switch --flake ./ && home-manager switch --flake ./ && sudo nix-collect-garbage --quiet --delete-older-than 5d"
